...
from vmkis.api.account.balance import KisBalance
from vmkis.api.account.daily_order import KisDailyOrders
from vmkis.api.account.order_profit import KisOrderProfits
...
class KisQuotableAccountMixin:
    ...
    from vmkis.api.account.balance import account_balance as balance  # 잔고 조회
    from vmkis.api.account.daily_order import (
