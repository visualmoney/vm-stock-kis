...
from vmkis.api.stock.order_book import KisOrderbookResponse
from vmkis.api.stock.quote import KisQuoteResponse
from vmkis.utils.timex import TIMEX_TYPE, timex
...
class KisQuotableProductMixin:
    ...
    from vmkis.api.stock.daily_chart import product_daily_chart as daily_chart  # 일봉 조회
    from vmkis.api.stock.day_chart import product_day_chart as day_chart  # 당일 봉 조회
    from vmkis.api.stock.order_book import product_orderbook as orderbook  # 호가 조회
    from vmkis.api.stock.quote import product_quote as quote  # 시세 조회
    ...
    def chart(
        ...
        *,
        ...
        if isinstance(period, int):
            ...
            from vmkis.api.stock.day_chart import product_day_chart
