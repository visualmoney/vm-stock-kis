...
from vmkis.api.base.market import KisMarketBase, KisMarketProtocol
from vmkis.api.stock.info import COUNTRY_TYPE
from vmkis.api.stock.market import MARKET_TYPE, get_market_name, get_market_timezone
...
def trading_hours(
    ...
    if market == "KRX":
        ...
        from vmkis.api.stock.day_chart import foreign_day_chart
