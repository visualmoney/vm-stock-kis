...
if TYPE_CHECKING:
    from vmkis.api.stock.market import CURRENCY_TYPE, MARKET_TYPE
...
class KisMarketBase(KisObjectBase):
    ...
    def market_name(self) -> str:
        """실제 상품유형명"""
        from vmkis.api.stock.market import get_market_name
    ...
    def currency(self) -> "CURRENCY_TYPE":
        """통화"""
        from vmkis.api.stock.market import get_market_currency
