...
from vmkis.api.base.account_product import (
    KisAccountProductBase,
    KisAccountProductProtocol,
)
from vmkis.api.stock.info import COUNTRY_TYPE, get_market_country
...
from vmkis.responses.types import KisAny, KisDecimal, KisString
...
class KisIntegrationPendingOrders(KisPendingOrdersBase):
    ...
    def __init__(self, kis: "VmKis", account_number: KisAccountNumber, *orders: KisPendingOrders):
        super().__init__()
        self.kis = kis
        self.account_number = account_number
